...
class Database:
    def __init__(self):
        ...
        """
        load_dotenv()
        var_host = os.environ.get("HOST")
        var_port = int(os.environ.get("PORT"))
        var_db = os.environ.get("DATABASE")
        var_user = os.environ.get("USER")
        var_pass = os.environ.get("PASSWORD")

        self.host = var_host
        self.port = var_port
        self.database = var_db
        self.user = var_user
        self.password = var_pass
